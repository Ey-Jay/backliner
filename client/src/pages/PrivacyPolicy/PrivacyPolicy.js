  ...
  return (
    <Container>
      ...
      <p>
        ...
        decided to use our Service, the Backliner website.
      </p>
      ...
      <p>
        For a better experience while using our Service, we require you to
        provide us with certain personally identifiable information, namely a
        token that gives us access to the public information of your Google
        account. This will be used to identify you.
      </p>

      <h2>Log Data</h2>

      <p>We do not collect any kind of Log Data.</p>
      ...
      <p>
        We only use cookies to keep you signed in to our Service. You have the
        option to accept these cookies, and know when a cookie is being sent to
        your computer. If you do not accept our cookies, you may not be able to
        use our Service.
      </p>
      ...
      <p>
        We only employ third-party providers in the form of using your Google
        Account to log you into our application, identify you as a user and –
        optionally – use our Service to view and edit the calendar of your
        Google account. However, no further data is sent to Google for any
        reasons.
      </p>
